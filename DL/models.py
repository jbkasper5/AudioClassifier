...
class Transformer(nn.Module):
    def __init__(self, **kwargs):
        ...
        self.trainloader, self.testloader = dataloaders.getDataloaders(dataset = "transformer_audio")

    def forward(self, x, tgt):
        print(self.transformer(x, tgt))
...
class CNN(nn.Module):
    def __init__(self, dropout = 0.25):
        ...
        self.trainloader, self.testloader = dataloaders.getDataLoader(dataset = "cnn_audio")
...
class CIFAR_CNN(nn.Module):
    ...
    def __init__(self):
        ...
        self.trainloader, self.testloader = dataloaders.getDataloaders(dataset = "cifar10")
